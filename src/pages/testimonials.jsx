...
const TESTIMONIALS_FULL = [
  ...
  { name:'Priya Mehta', role:'Secretary, Sunrise Cooperative Society', loc:'Thane (West)', text:'Their commitment to our society was truly unmatched. Deepak sir was available day and night during the critical negotiation phases. Because of their relentless guidance and legal expertise, we secured premium terms with a reputed builder. Every family in our society is grateful.', tag:'Society Secretary' },
